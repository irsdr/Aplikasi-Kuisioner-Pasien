    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <label for="inputEmail" class="col-lg-2">Pekerjaan</label>
            <div class="col-lg-12">
              <input type="text" class="form-control" name="responden">
			  <div class="form-group">
			<label for="inputEmail" class="col-lg-2">Jenis Kelamin</label>
            <div class="col-lg-12">
...
value="male">Laki-laki
			  <div class="form-group">
			<label for="inputEmail" class="col-lg-2">Usia</label>
            <div class="col-lg-12">
