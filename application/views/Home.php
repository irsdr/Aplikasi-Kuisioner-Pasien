  ...
  <body>
    ...
    <div class="container">
      <div class="page-header">
          <h2 id="navbar"><center>Selamat Datang . . .</center></h2>
		  <h3 id="navbar"><center>Silahkan Isi Kuisioner Survey Sebagai Bahan Penelitian Kami !!!</center></h3>
      <p class="text-center">Created by <a href="https://www.instagram.com/_bayusam" target="_blank" rel="noopener noreferrer">Leo Bayu Samudra</a></p>
    </div>
    <div class="">
      <center><a href="<?php echo base_url() ;?>Input" class="btn btn-info btn-lg">Mulai Isi Kuisioner</a></center>
    </div>
    
    </div>
<body background = "assetsh/gambar/Bg3.jpg">	
