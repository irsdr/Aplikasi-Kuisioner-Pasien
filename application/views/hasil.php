...
<body>
  ...
  <div class="panel panel-info col-lg-3">
    ...
    <div class="panel-body">
      <div class="list-group">
        ...
        <a href="<?php echo base_url(); ?>Hasil/P6" class="list-group-item">
          Pertanyaan 6
        </a>
        <a href="<?php echo base_url(); ?>Hasil/P7" class="list-group-item">
          Pertanyaan 7
        </a>
        <a href="<?php echo base_url(); ?>Hasil/P8" class="list-group-item">
          Pertanyaan 8
        </a>
        <a href="<?php echo base_url(); ?>Hasil/P9" class="list-group-item">
          Pertanyaan 9
        </a>
  ...
  <div class="container col-lg-9">
    <p> Dari <span class="label label-success"><?php echo $total_r; ?></span> Responden Untuk pertanyaan Ini Menjawab <b>(a)</b> = <span class="label label-info"><?php echo $p1_j1; ?></span>, <b>(b)</b> = <span class="label label-info"><?php echo $p1_j2; ?></span>, <b>(c)</b> = <span class="label label-info"><?php echo $p1_j3; ?></span>, Dan <b>(d)</b> = <span class="label label-info"><?php echo $p1_j4; ?></span> Orang</p>
    <div class="page-header">
    ...
    <script>
      ...
      var chartData = <?php echo json_encode($total_r); ?>;
            ...
            yAxes: [{
              ticks: {
                ...
                callback: function(value) {
                  return value + '%'; // Menambahkan tanda persen pada nilai sumbu y
                }
              }
            }]
          },
          tooltips: {
            callbacks: {
              label: function(tooltipItem, data) {
                ...
                var percentage = Math.floor(((currentValue / total) * 100) + 0.5); // Menghitung persentase
                return percentage + "%";
              }
            }
          }
